        ...
        <div className="row d-flex justify-content-center">
          <div className="col-xl-10 mt-9 mb-20">
            ...
            <div>
              ...
              <div className="border border-nature-90 rounded-2 rounded-lg-4 px-4 px-lg-6">
                ...
                <div className="container py-5">
                  <div className="row gy-4">
                    <div className="col-12 col-lg-4">
                      <p className="text-primary-50 fs-Body-2 mb-2">密室名稱</p>
                      <p>{group.game_name}</p>
                    </div>
                    <div className="col-12 col-lg-4">
                    ...
                    <div className="col-12 col-lg-4">
                      <p className="text-primary-50 fs-Body-2 mb-2">活動日期</p>
                      <p>{group.group_active_date}</p>
                    </div>
                  </div>
                  <div className="row gy-4">
                    <div className="col-12">
                      <p className="text-primary-50 fs-Body-2 mb-2">密室地址</p>
                      <p>{group.game_address}</p>
                    </div>
                  </div>
                  <div className="row gy-4">
                    <div className="col-6 col-lg-2">
                      <p className="text-primary-50 fs-Body-2 mb-2">需求人數</p>
                  ...
                  <div className="row gy-4">
                    ...
                    <div className="col-6 col-lg-10">
                      <p className="text-primary-50 fs-Body-2 mb-2">聯絡方式</p>
                      <p>{group.group_channel}</p>
                    </div>
                  </div>
                  <div className="row gy-4">
                    <div className="col-12">
                      <p className="text-primary-50 fs-Body-2 mb-2">揪團理念</p>
