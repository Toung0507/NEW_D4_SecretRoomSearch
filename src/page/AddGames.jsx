...
function AddGames() {
  ...
  const handlEInputChange = (e) => {
    ...
    setValue("gameFormData.property", updatedProperties, {
      shouldValidate: true,
    });
  ...
  const isDateValid = useCallback(() => {
    ...
    if (isLimited === null) {
      ...
      if (!gameFormData.game_start_date && !gameFormData.game_end_date) {
        ...
        if (
          new Date(gameFormData.game_end_date) <
          new Date(gameFormData.game_start_date)
        ) {
          setError("gameFormData.game_end_date", {
            type: "manual",
    ...
    setError,
    clearErrors,
    gameFormData.game_end_date,
    gameFormData.game_start_date,
  ]);
  ...
  const CompareData = async (games, prices) => {
    ...
    if (addOrEdit === "edit") {
      ...
      const isPropertyDirty =
        JSON.stringify(currentProperty) !== JSON.stringify(initialProperty);
      ...
      if (
        ...
        if (
          (dirtyFields.gameFormData &&
            Object.keys(dirtyFields.gameFormData).length > 0) ||
          isDateDirty ||
          isPropertyDirty
        ) {
        ...
        if (
          dirtyFields.priceFormData &&
          Object.keys(dirtyFields.priceFormData).length > 0
        ) {
          await deldetePrice();
  ...
  const getStoreGameInfo = useCallback(async () => {
    ...
    try {
      ...
      const allGamesInfo = res.data.find(
        (item) => Number(game_id) === Number(item.game_id)
      );
  ...
  const handleGetPrices = (data) => {
    ...
    const gamePrices = data.reduce(
      (acc, item) => {
        if (acc.game_id !== 0) {
          //確認game_id是否有被取出
          acc.game_id = item.game_id;
        }
        if (!acc.price_is_difference) {
          // 確認平假日相符是否被取出
        ...
        const priceObj = {
          min: item.price_people.includes("-")
            ? item.price_people.split("-")[0] || ""
            : item.price_people.replace(/\D/g, "") || "",
          max: item.price_people.includes("-")
            ? (item.price_people.split("-")[1] || "").replace(/\D/g, "")
            : item.price_people.replace(/\D/g, "") || "",
  ...
  useEffect(() => {
    if (
      Object.keys(propertys).length > 0 &&
      Object.keys(difficultys).length > 0 &&
                  ...
                  <div className="bg-secondary-95 py-3 px-6 rounded-top-3 fw-bold fs-h6 text-secondary-50 text-center">
                    ...
                    <p>
                      <Link
                        ...
                        className="btn bg-nature-60 text-white mt-3"
                      >
                        返回列表
                      </Link>
                    </p>
                  ...
                  <form onSubmit={(e) => onSubmit(e)}>
                      ...
                      <div className="px-6">
                        <div className="border border-1 border-nature-90 rounded-3 p-6">
                          ...
                          <div className="row">
                            <label
                              htmlFor="store_name"
                              className="col-sm-2 fs-Body-2 fw-bold fs-sm-Body-1 mb-2 mb-sm-0"
                            >
                              店家名稱
                            </label>
                          ...
                          <div className="p-6">
                            ...
                            <div className="row mb-3">
                              ...
                              <div className="col-sm-10">
                                ...
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_name
                                    ? errors?.gameFormData?.game_name.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row mb-3">
                              ...
                              <div className="col-sm-10">
                                ...
                                />
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_address
                                    ? errors?.gameFormData?.game_address.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row mb-3">
                              ...
                              <div className="col-sm-10">
                                ...
                                />
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_tel
                                    ? errors?.gameFormData?.game_tel.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row mb-3">
                              ...
                              <div className="col-sm-10">
                                ...
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_time
                                    ? errors?.gameFormData?.game_time.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row mb-5">
                              ...
                              <div className="col-sm-10">
                                <div className="d-flex align-items-center">
                                  <input
                                    defaultValue={
                                      gameFormData?.game_minNum_Players
                                    }
                                    {...register(
                                      "gameFormData.game_minNum_Players",
                                      {
                                        ...
                                        onChange: async () => {
                                          ...
                                          await trigger(
                                            "gameFormData.game_maxNum_Players"
                                          ); // 當最小值改變時，重新驗證最大值
                                        },
                                      }
                                    )}
                            ...
                            <div className="row mb-3">
                              ...
                              <div className="col-sm-10">
                                ...
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_info
                                    ? errors?.gameFormData?.game_info.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row mb-3">
                              ...
                              <div className="col-sm-10">
                                  ...
                                  <input
                                    ...
                                    {...register("gameFormData.game_website", {
                                      ...
                                      pattern: {
                                        value: /^(https?:\/\/)[^\s]+$/i,
                                        message:
                                          "請輸入正確的網址格式（例如：https://example.com）",
                                      },
                                      onChange: async () => {
                                        await trigger(
                                          "gameFormData.game_website"
                                        );
                                      },
                                    })}
                                    type="text"
                                ...
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_website
                                    ? errors?.gameFormData?.game_website.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row mb-3">
                              ...
                              <div className="col-sm-10">
                                ...
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_remark
                                    ? errors?.gameFormData?.game_remark.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row ">
                              ...
                              <div className="col-sm-10">
                                <input
                                  ...
                                  {...register("gameFormData.game_img", {
                                    ...
                                    pattern: {
                                      ...
                                      message:
                                        "請輸入正確的圖片 URL（例如：https://example.com/image.jpg）",
                                    },
                                    onChange: () => {
                                ...
                                />
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_img
                                    ? errors?.gameFormData?.game_img.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="p-6">
                            ...
                            <div className="row mb-3">
                              ...
                              <div className="col-sm-10">
                                ...
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_dif_tag
                                    ? errors?.gameFormData?.game_dif_tag.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="row">
                              ...
                              <div className="col-sm-10">
                                  ...
                                  {propertys.map((property) => (
                                    ...
                                    >
                                      <input
                                        ...
                                        name="property"
                                        checked={gameFormData?.property.includes(
                                          Number(property.property_id)
                                        )}
                                        disabled={
                                          gameFormData?.property.length >= 2 &&
                                          !gameFormData?.property.includes(
                                            Number(property.property_id)
                                          )
                                        }
                                      />
                                ...
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.property
                                    ? errors?.gameFormData?.property.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                              ...
                              <div className="col-sm-10">
                                <div className="d-flex align-items-center">
                                  <DatePicker
                                    ...
                                    onChange={(e) =>
                                      handleDateChange(e, "game_start_date")
                                    }
                                  ...
                                  <DatePicker
                                    ...
                                    name="game_end_date"
                                    onChange={(e) =>
                                      handleDateChange(e, "game_end_date")
                                    }
                                    customInput={<CustomDateInput />}
                                  />
                                </div>
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.gameFormData?.game_end_date
                                    ? errors.gameFormData.game_end_date.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="p-6">
                              ...
                              <div className="col-sm-10">
                                <div className="d-flex">
                                  ...
                                  <div className="form-check me-6">
                                    <input
                                      {...register(
                                        "priceFormData.price_is_difference",
                                        {
                                          required: "平假日是否相符必填",
                                          onChange: async () => {
                                            await trigger(
                            ...
                            <div className="row mb-3">
                              ...
                              <div className="col-sm-10">
                                ...
                                <div className="error-message text-danger mt-1 fs-caption lh-1">
                                  {errors?.priceFormData?.price_people
                                    ? errors.priceFormData.price_people.message
                                    : "　"}
                                </div>
                              </div>
                            </div>
                            ...
                            {watch("priceFormData.price_is_difference") ===
                              "0" &&
                              watch("priceFormData.price_people") === "/場" && (
                                <div className="row mb-8">
                                  ...
                                  <div className="col-sm-10">
                                    <div className="d-flex align-items-center">
                                      ...
                                      />
                                      <span className="ms-1 me-3">元</span>
                                    </div>
                                    <div className="error-message text-danger mt-1 fs-caption lh-1">
                            ...
                            {watch("priceFormData.price_is_difference") ===
                              "0" &&
                              watch("priceFormData.price_people") === "/人" && (
                                <div className="row mb-8">
                                  <label
                                    htmlFor="unit_person_price"
                                    className="col-sm-2 fs-Body-2 fw-bold fs-sm-Body-1 mb-2 mb-sm-0"
                                  >
                                    人頭收費
                                  </label>
                                  <div className="col-sm-10">
                                    <div className="d-flex align-items-center">
                                      <input
                                        {...register(
                                          "priceFormData.unit_person_price",
                                          {
                                            required: "單人收費金額必填",
                                            onChange: async () => {
                                              await trigger(
                                  ...
                                  <div className="col-sm-10">
                                    <div className="d-flex flex-column w-100">
                                      <div className="d-flex align-items-center">
                                        ...
                                        <input
                                          {...register(
                                            "priceFormData.unit_weekday_price",
                                            {
                                              required: "平日收費金額必填",
                                              onChange: async () => {
                                                await trigger(
                                      ...
                                      <div className="d-flex align-items-center mt-3">
                                        ...
                                        <input
                                          {...register(
                                            "priceFormData.unit_weekend_price",
                                            {
                                              required: "假日收費金額必填",
                                              onChange: async () => {
                                                await trigger(
                                      ...
                                      <div key={item.id}>
                                        <div className="d-flex align-items-center col-sm-8">
                                          <input
                                            ...
                                            className="form-control border-black w-25"
                                            {...register(
                                              `priceFormData.prices.unit.${index}.min`,
                                              {
                                                required: "請輸入開始人數",
                                                onChange: async () => {
                                                  await trigger(
                                                  ...
                                                  await trigger(
                                                    `priceFormData.prices.unit.${index}.group`
                                                  );
                                                },
                                              }
                                            )}
                                          ...
                                          <input
                                            ...
                                            className="form-control border-black w-25"
                                            {...register(
                                              `priceFormData.prices.unit.${index}.max`,
                                              {
                                                required: "請輸入結束人數",
                                                onChange: async () => {
                                                  await trigger(
                                          ...
                                          <input
                                            ...
                                            className="form-control border-black w-25"
                                            {...register(
                                              `priceFormData.prices.unit.${index}.price_mix`,
                                              {
                                                required: "請輸入單人價格",
                                                onChange: async () => {
                                                  await trigger(
                                        ...
                                        <div key={item.id}>
                                          <div className="d-flex align-items-center col-sm-8">
                                            <input
                                              ...
                                              className="form-control border-black w-25"
                                              {...register(
                                                `priceFormData.prices.weekday.${index}.min`,
                                                {
                                                  required: "請輸入開始人數",
                                                  onChange: async () => {
                                                    await trigger(
                                                    ...
                                                    await trigger(
                                                      `priceFormData.prices.weekday.${index}.group`
                                                    );
                                                  },
                                                }
                                              )}
                                            ...
                                            <input
                                              ...
                                              className="form-control border-black w-25"
                                              {...register(
                                                `priceFormData.prices.weekday.${index}.max`,
                                                {
                                                  required: "請輸入結束人數",
                                                  onChange: async () => {
                                                    await trigger(
                                            ...
                                            <input
                                              ...
                                              className="form-control border-black w-25"
                                              {...register(
                                                `priceFormData.prices.weekday.${index}.price_mix`,
                                                {
                                                  required: "請輸入單人價格",
                                                  onChange: async () => {
                                                    await trigger(
                                        ...
                                        <div key={item.id}>
                                          <div className="d-flex align-items-center col-sm-8">
                                            <input
                                              ...
                                              className="form-control border-black w-25"
                                              {...register(
                                                `priceFormData.prices.weekend.${index}.min`,
                                                {
                                                  required: "請輸入開始人數",
                                                  onChange: async () => {
                                                    await trigger(
                                                    ...
                                                    await trigger(
                                                      `priceFormData.prices.weekend.${index}.group`
                                                    );
                                                  },
                                                }
                                              )}
                                            ...
                                            <input
                                              ...
                                              className="form-control border-black w-25"
                                              {...register(
                                                `priceFormData.prices.weekend.${index}.max`,
                                                {
                                                  required: "請輸入結束人數",
                                                  onChange: async () => {
                                                    await trigger(
                                            ...
                                            <input
                                              ...
                                              className="form-control border-black w-25"
                                              {...register(
                                                `priceFormData.prices.weekend.${index}.price_mix`,
                                                {
                                                  required: "請輸入單人價格",
                                                  onChange: async () => {
                                                    await trigger(
                    ...
                    <div className="p-6 fw-bold fs-h6 border-top border-nature-90  ">
                      <div className="d-flex justify-content-end">
                        <Link
                          to={`/Store_profile/${user_id}/myGames`}
                          className="btn bg-nature-60 text-white me-3"
                        >
                          返回列表
                        </Link>
                        <button className="btn bg-secondary-60 text-white ">
                          送出審核
                        </button>
                      </div>
                    </div>
