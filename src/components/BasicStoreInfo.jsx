...
const BasicInfo = () => {
  ...
  const {
    register: storeData,
    handleSubmit: handleStoreData,
    formState: { errors: storeErrors },
    setValue: setStoreValue,
  } = useForm();
  const {
    register: storeUserData,
    handleSubmit: handleStoreUserData,
    formState: { errors: storeUserErrors },
    setValue: setStoreUserValue,
    watch,
  } = useForm();
  ...
  const onSubmitStoreUser = handleStoreUserData((data) => {
    ...
    const { userData, storeData } = Object.entries(data).reduce(
      (acc, [key, value]) => {
  ...
  const handleAuthPassword = async () => {
    ...
    if (res.meta.requestStatus === "fulfilled") {
      ...
      setPasswordError(
        res.payload === "信箱及密碼需要輸入" || res.payload === "密碼請超過4碼"
          ? "請輸入密碼驗證或密碼未超過4碼"
          : res.payload
      );
    }
  ...
  return (
    <>
                ...
                <span className="fs-Body-2 fs-lg-h6">
                  {store.store_isAuth === "processing" ? (
                    <span className="text-secondary-40">
                      <IoInformationCircle className="ms-3 me-1" />{" "}
                      發布遊戲資格審核中
                    </span>
                  ) : store.store_isAuth === "pass" ? (
                    <span className="text-success">
                      <FaCheckDouble className="ms-3 me-1" />{" "}
                      審核成功，可新增遊戲
                    </span>
                  ) : (
                    <span className="text-danger">
                      <VscError className="ms-3 me-1" />{" "}
                      資格審核失敗，請再次確認相關資訊，才可發布遊戲
                    </span>
                  )}
                </span>
              </p>
            ...
            <div className="user_information p-6 ">
              ...
              >
                ...
                <div className="row mb-1">
                  <label
                    htmlFor="user_name"
                    className="col-sm-2 fs-Body-2 fs-sm-Body-1 mb-2 mb-sm-0"
                  >
                    店家名稱
                  </label>
                  <div className="col-sm-10">
                    ...
                    <div className="error-message text-danger mt-1 fs-caption lh-1">
                      {storeUserErrors.user_name
                        ? storeUserErrors.user_name.message
                        : "　"}
                    </div>
                  </div>
                </div>
                ...
                <div className="row mb-1">
                  ...
                  <div className="col-sm-10">
                    <input
                      {...storeUserData("user_email", {
                        ...
                        pattern: {
                          ...
                          message:
                            "請輸入有效的 Email 格式，如 example@mail.com",
                        },
                      })}
                      type="text"
                      className={`form-control ${
                    ...
                    />
                    <button
                      className="text-secondary-50 bg-transparent border-0 border-bottom pt-1 "
                      onClick={openUpdatePassword}
                    >
                      修改密碼
                    </button>
                    <div className="error-message text-danger mt-1 fs-caption lh-1">
                      {storeUserErrors.user_email
                        ? storeUserErrors.user_email.message
                        : "　"}
                    </div>
                  </div>
                </div>
                ...
                <div className="row mb-1">
                  ...
                  <div className="col-sm-10">
                    ...
                    />
                    <div className="error-message text-danger mt-1 fs-caption lh-1">
                      {storeUserErrors.user_tel
                        ? storeUserErrors.user_tel.message
                        : "　"}
                    </div>
                  </div>
                </div>
                ...
                <div className="row mb-1">
                  ...
                  <div className="col-sm-10">
                    ...
                    />
                    <div className="error-message text-danger mt-1 fs-caption lh-1">
                      {storeUserErrors.store_contact
                        ? storeUserErrors.store_contact.message
                        : "　"}
                    </div>
                  </div>
                </div>
                ...
                <div className="row mb-1">
                  ...
                  <div className="col-sm-10">
                    ...
                    <div className="error-message text-danger mt-1">
                      {storeUserErrors.store_self_address
                        ? storeUserErrors.store_self_address.message
                        : "　"}
                    </div>
                  </div>
                </div>
                ...
                <div className="row mb-3">
                  <label
                    ...
                    className="col-sm-2 col-form-label fs-Body-2 fs-sm-Body-1 mb-2 mb-sm-0"
                  >
                    驗證方式
                  </label>
                  <div className="col-sm-5">
                    ...
                    <div className="error-message text-danger mt-1">
                      {storeUserErrors.store_method
                        ? storeUserErrors.store_method.message
                        : "　"}
                    </div>
                  </div>
                  <div className="col-sm-5">
                    ...
                    <div className="error-message text-danger mt-1">
                      {storeUserErrors.store_tax_id
                        ? storeUserErrors.store_tax_id.message
                        : "　"}
                      {storeUserErrors.store_documentation
                        ? storeUserErrors.store_documentation.message
                        : "　"}
                    </div>
                  </div>
                </div>
      ...
      {/* 場館資料 */}
      <div className="col-lg-8  m-0 px-0 mt-5 mb-10 mt-sm-0">
        <div className="border-nature-90 border rounded-2">
          <div className="BasicStoreInfoTitle fs-h6 lh-sm bg-secondary-95 fw-bold px-5 py-5 text-secondary-50">
            場館資料(以下為提供給訪客的資訊)
            <p className="fs-Body-1 mt-1 text-black fw-normal">
              <span className="text-danger">*</span> 代表可在不同密室上進行更改
            </p>
          </div>
          <div className="user-info bg-white ">
            {/* 表單 */}
            <div className="user_information p-6 ">
              ...
              >
                  ...
                  <div className="col-sm-10">
                    ...
                    <div className="error-message text-danger mt-1 fs-caption lh-1">
                      {storeErrors.store_name
                        ? storeErrors.store_name.message
                        : "　"}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-sm-10">
                    <AddressForm
                      onChange={(fullAddress) => {
                        ...
                        handleInputStore({
                          target: { name: "store_address", value: fullAddress },
                        });
                      }}
                    ...
                    />
                    <div className="error-message text-danger mt-1">
                      {storeErrors.store_address
                        ? storeErrors.store_address.message
                        : "　"}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-sm-10">
                    ...
                    <div className="error-message text-danger mt-1 fs-caption lh-1">
                      {storeErrors.store_email
                        ? storeErrors.store_email.message
                        : "　"}
                    </div>
                  </div>
                </div>
                {/* 電話 */}
                <div className="row mb-1">
                  <label htmlFor="store_tel" className="col-sm-2">
                    電話
                  </label>
                  <div className="col-sm-10">
                    <input
                    ...
                    />
                    <div className="error-message text-danger mt-1 fs-caption lh-1">
                      {storeErrors.store_tel
                        ? storeErrors.store_tel.message
                        : "　"}
                    </div>
                  </div>
                </div>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body px-5 py-10">
              <input
                type="password"
                className="w-100 border border-1 border-black rounded-1 "
                ref={authpasswordRef}
              />
              <div
            ...
            <div className="modal-footer">
              <div className="btn_2 d-flex  text-center ">
                ...
                <button
                  type="button"
                  className="btn bg-secondary-60 text-white"
                  onClick={handleNewInputPassword}
                >
                  儲存變更
                </button>
              </div>
